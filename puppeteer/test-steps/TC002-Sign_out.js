...
puppeteer.launch({ headless: false }).then(async (browser) => {
    ...
    try {
        ...
        await page.screenshot({
            path: `TC-002-Step 2-Result on ${date}.png`,
        })

        // Test Step 3 : Pengguna menekan tombol sign out
        await page.locator('a#sign_out_btn').click()
        await page.evaluate(() => new Promise(resolve => setTimeout(resolve, 3000)))
        await page.screenshot({ path: `TC-002-Step 3-Result on ${date}.png` })
        ...
        await page.waitForNavigation()
        await page.screenshot({ path: `TC-002-Step 4-Result on ${date}.png` })
        ...
        let data = {
            ...
            tc_evidence_name: [`TC-002-Step 2-Result on ${date}.png`,`TC-002-Step 3-Result on ${date}.png`,`TC-002-Step 4-Result on ${date}.png`],
            tested_at: date,
            tc_base_url: BASEURL
        };
        ...
        await page.evaluate(() => {
            alert(`TC-002 Sign Out Test Success`)
        }, [])
    } catch (error) {
